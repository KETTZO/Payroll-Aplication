...
{
    public partial class Cambios_Departamento_Ingresar : Form
    {
        string NumDepar;
        public Cambios_Departamento_Ingresar(string Num)
        {
            NumDepar = Num;
            InitializeComponent();
        }

        private void Cambios_Departamento_Ingresar_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (result)
            {
                tablaPercepcion_Deduccion = obj.get_Percepcione_Deducciones(1, 0, NomCamSld.Text, Tipo.Text, float.Parse(Cantidad.Text), TipoCan.Text, "D", Int32.Parse(NumDepar), 0, FechaAplicacion.Value);
